...
class PoseClassificationVisualizer():
	...
	def _plot_classification_history(self, output_width, output_height):
		...
		y = []
		for classification in self._pose_classification_filtered_history:
		...
		plt.ylabel('Confidence',fontsize = 30)
		plt.title('Classification for `{}`'.format(self._class_name),fontsize = 40)
