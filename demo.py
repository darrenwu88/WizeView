...
class gui():
	...
	def tab6(self):
		...
		self.label9 = tk.Label(self.root,
							   text="Your result is " + str(self.repetitions_count),
							   font=('Arial',50))
		self.label9.pack()
	...
	def video_test(self):
		if self.passed == 30:
			self.button7 = tk.Button(self.root, text="Check Results", command=self.tab6)
		...
		if results.pose_landmarks is not None:
			...
			# Count repetitions.
			self.repetitions_count = self.repetition_counter(pose_classification_filtered)
		else:
